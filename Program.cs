namespace MathClass
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int num1 = 13;
            int num2 = 9;
            Console.WriteLine("floor of num1 {0} and num2 {1} is {2}",num1,num2,Math.Min(num1,num2));
            Console.WriteLine("Higher of num1 {0} and num2 {1} is {2}",num1,num2,Math.Min(num1,num2));

            Console.WriteLine("3 to the power of 5 is {0}",Math.Pow(3,5));
            Console.WriteLine("P1 is: {0}",Math.PI);
